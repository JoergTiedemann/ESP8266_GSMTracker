...
export function DashboardPage(props) {
    ...
    const dashboardArrData = props.requestArrData();
    
    const confItems = <DashboardItems API={props.API} items={Dash} data={dashboardData} Arrdata={dashboardArrData} />;
